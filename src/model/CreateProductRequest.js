 ...
 * @member {module:model/CreateProductRequest.CancelActionEnum} cancel_action
 */
CreateProductRequest.prototype['cancel_action'] = undefined;

/**
 * Title of the product.
 * @member {String} title
 */
CreateProductRequest.prototype['title'] = undefined;
 ...
 */
CreateProductRequest.prototype['expiration_days'] = undefined;

/**
 * 3 letter currency code.
 * @member {String} currency
 */
CreateProductRequest.prototype['currency'] = undefined;

/**
 * One time payments charge the user at purchase Renewal charge the user every set period. Can be: one_time, renewal.
 * @member {module:model/CreateProductRequest.LicenseTypeEnum} license_type
 */
CreateProductRequest.prototype['license_type'] = undefined;

/**
 * The initial purchase price.
 * @member {Number} initial_price
 */
CreateProductRequest.prototype['initial_price'] = undefined;
 ...
 */
CreateProductRequest.prototype['billing_period'] = undefined;

/**
 * Amount of inventory available.
 * @member {Number} stock
 */
CreateProductRequest.prototype['stock'] = undefined;

/**
 * @member {Boolean} transferable
 */
CreateProductRequest.prototype['transferable'] = undefined;

/**
 * Show time of the trial period in days.
 * @member {Number} custom_trial_period
 */
CreateProductRequest.prototype['custom_trial_period'] = undefined;
 ...
 * @readonly
 */
CreateProductRequest['CancelActionEnum'] = {
 ...
 * @readonly
 */
CreateProductRequest['LicenseTypeEnum'] = {
